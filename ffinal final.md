...
FAKOREDE, Isiah Ayomide

Group Leader / Lead Program Developer for Assignment 3

2

230805157

TAIWO, Oluwapelumi Emmanuel

Lead Program Developer for Assignment 1

3

230805025

IFENKWE, Chijindu Praise

Lead Program Developer for Assignment 2

4

230805127

AFENISUMEN, Enoch Oluwagbemisoke

Lead Program Developer for Assignment 4 & 5

5

230805090

OKONKWO, Sebastian Chiedozie
...
The problem is divided into two distinct parts: analyzing crime-reporting systems to identify common features, and analyzing deep learning research papers to extract structural patterns through sub-headings. Extracting relevant information, categorizing by frequency, and visualizing results.
...
Articles on crime reporting papers from search engine

At least 10 distinctive features from the papers extracted from the articles

**Part 2 - Deep Learning Papers**:

Journals on deep learning from search engine

At least 10 distinctive sub-headings extracted from the journals 

 

PROCESS

Collection of data(SERP results)

Extraction of distinctive features

Multithreading programming:

Use of threads to execute small tasks to maximize performance

MODELS USED(CITATIONS)

- Google:

 for search results on articles and journal
...
- Chatgpt:
 	 for project walkthrough and BREA
- IMPLEMENTATION FOR CRIME ARTICLES (CODE INPUT AND OUTPUT)
...
-  IMPLEMENTATION FOR DEEP LEARNING JOURNALS (CODE INPUT AND OUTPUT)
...
With the implementation of a program like this into modern systems/programs, it is certain that useful information about a particular subject can be easily extracted and used.
...
tryLock(100ms) + Random(0-50ms)

Starvation

Fair semaphore + retry
...
Efficient waiting (no busy-wait)
...
Multithreading, Thread Pools, Visualization
...
Synchronization, Delegation, Immutability
